...
APP_CONFIG = ApplicationConfig(
    ...
    appVersion="",
    enableSemanticEmbedding=to_bool(os.getenv("AA_ENABLE_BGE_M3", "true")),
    enableHybridRetrieval=to_bool(os.getenv("AA_ENABLE_HYBRID_RETRIEVAL", "true")),
    enableSemanticReranker=to_bool(os.getenv("AA_ENABLE_RERANKER", "true")),
    enableLightgbmClassifier=to_bool(os.getenv("AA_ENABLE_LIGHTGBM", "true")),
    enableOptunaTuning=to_bool(os.getenv("AA_ENABLE_OPTUNA", "true")),
    enableFlakyDetection=to_bool(os.getenv("AA_ENABLE_FLAKY_DETECTION", "true")),
    enableAsyncMlPipeline=to_bool(os.getenv("AA_ENABLE_ASYNC_PIPELINE", "true")),
    semanticModelCacheDir=os.getenv("AA_MODEL_CACHE_DIR", "res/model/runtime").strip(),
    semanticEmbedderModelId=os.getenv("AA_BGE_M3_MODEL_ID", "qdrant/bge-small-en-v1.5-onnx-q").strip(),
    semanticRerankerModelId=os.getenv("AA_BGE_RERANKER_MODEL_ID", "Xenova/ms-marco-TinyBERT-L-2-v2").strip(),
    semanticEmbedderModelPath=os.getenv("AA_BGE_M3_MODEL_PATH", "res/model/runtime/bge-small-en-v1.5").strip(),
    semanticRerankerModelPath=os.getenv("AA_BGE_RERANKER_MODEL_PATH", "res/model/runtime/ms-marco-TinyBERT-L-2-v2").strip(),
    semanticEmbedderModelFile=os.getenv("AA_BGE_M3_MODEL_FILE", "model_optimized.onnx").strip(),
    semanticRerankerModelFile=os.getenv("AA_BGE_RERANKER_MODEL_FILE", "onnx/model.onnx").strip(),
    hybridRrfK=int(os.getenv("AA_HYBRID_RRF_K", "60")),
    hybridCandidatePoolSize=int(os.getenv("AA_HYBRID_CANDIDATE_POOL", "50")),
    rerankerCandidateWindow=int(os.getenv("AA_RERANK_CANDIDATES", "30")),
    rerankerResultWindow=int(os.getenv("AA_RERANK_RESULTS", "10")),
    mlPipelineTimeoutSeconds=int(os.getenv("AA_PIPELINE_TIMEOUT_SECONDS", "5")),
    semanticEmbeddingBatchSize=int(os.getenv("AA_EMBEDDING_BATCH_SIZE", "32")),
    optunaMaxTrials=int(os.getenv("AA_OPTUNA_MAX_TRIALS", "15")),
    optunaMinF1Score=float(os.getenv("AA_OPTUNA_MIN_F1", "0.80")),
    flakyQuarantineThreshold=int(os.getenv("AA_FLAKY_THRESHOLD", "75")),
    semanticVectorDimension=int(os.getenv("AA_SEMANTIC_VECTOR_DIM", "384")),
    # Storage settings
