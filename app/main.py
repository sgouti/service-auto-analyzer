...
APP_CONFIG = ApplicationConfig(
    ...
    semanticEmbedderModelId=os.getenv("AA_BGE_M3_MODEL_ID", "BAAI/bge-m3").strip(),
    semanticRerankerModelId=os.getenv("AA_BGE_RERANKER_MODEL_ID", "BAAI/bge-reranker-base").strip(),
    semanticEmbedderModelPath=os.getenv("AA_BGE_M3_MODEL_PATH", "res/model/runtime/bge-m3").strip(),
    semanticRerankerModelPath=os.getenv("AA_BGE_RERANKER_MODEL_PATH", "res/model/runtime/bge-reranker-base").strip(),
    semanticEmbedderModelFile=os.getenv("AA_BGE_M3_MODEL_FILE", "onnx/model.onnx").strip(),
    ...
    semanticVectorDimension=int(os.getenv("AA_SEMANTIC_VECTOR_DIM", "1024")),
    # Storage settings
